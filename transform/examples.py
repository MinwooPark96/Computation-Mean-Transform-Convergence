...
if __name__ == "__main__":
    ...
    matrix_list2 = meantrans2.get_matrix_list(is_np = False)
    ...
    matrix_list3 = meantrans3.get_matrix_list(is_np = False)
    ...
    matrix_list4 = meantrans4.get_matrix_list(is_np = False)
    utils.save(meantrans=meantrans4, name = 'ex4')
    
    matrix5 = np.matrix([2,-1,3,4]).reshape(2,2)
    meantrans5 = transform.Meantrans(matrix5)
    meantrans5.compute(100)
    matrix_list5 = meantrans5.get_matrix_list(is_np = False)
